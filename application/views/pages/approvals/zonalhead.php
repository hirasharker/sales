                            ...
                            <table id="datatable-buttons1" class="table table-striped table-bordered responsive">
                                ...
                                <?php foreach($customer_list as $value){ if($value->status==0){if($this->session->userdata('employee_id')==$value->zhead_id || $this->session->userdata('employee_id')==28){ ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url().'files/'.$value->upload_path.'/'.$value->image_path?>" target="_blank"><img width="30px" height="40px" src="<?php echo base_url().'files/'.$value->upload_path.'/'.$value->image_path?>" alt="image"></a></td>
                                        <td><a href="<?php echo base_url().'nid/'.$value->upload_path.'/'.$value->nid_path;?>" target="_blank"><img width="30px" height="40px" src="<?php echo base_url().'nid/'.$value->upload_path.'/'.$value->nid_path?>" alt="nid"></a></td>
                                        <td>
                                        <?php if($value->purchase_order!=''){?>
                                        <a href="<?php echo base_url().'purchase_order/'.$value->upload_path.'/'.$value->purchase_order;?>" target="_blank"><img width="30px" height="40px" src="<?php echo base_url().'purchase_order/'.$value->upload_path.'/'.$value->purchase_order?>" alt="p_order"></a>
                                        <?php } else { echo '___';}?>
                                        </td>
