        ...
        <div class="x_panel">
            ...
            <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>customer/add_customer/" enctype='multipart/form-data'>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="number" class="form-control" name="national_id" min="0" placeholder="">
                  </div>
                </div>
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12" style="display:block">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <select class="form-control select-tag" name="sales_generated_by">
                        ...
                        <?php foreach($employee_list as $value){if($value->role == 1 || $value->role == 4){?> 
                        <option value="<?php echo $value->employee_id; ?>"><?php echo $value->employee_name;?></option>
                        <?php }}?>
                      </select>
                  </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Additional Charge </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input id="total-price" type="number" class="form-control" name="additional_charge"  min="0" value="0" placeholder="">
                  </div>
                </div>
            ...
            <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>customer/update_customer/" enctype='multipart/form-data'>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <option value="20" <?php if($customer_detail->status == 20){echo 'selected';} ?> >Canceled</option>
                      </select>
                  </div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Additional Charge </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input id="total-price" type="number" class="form-control" name="additional_charge"  min="0" value="<?php echo $customer_detail->additional_charge; ?>" placeholder="">
                  </div>
                </div>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="x_panel">
            ...
            <form class="form-horizontal form-label-left" method="post"  enctype='multipart/form-data'>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Customer ID / Name / Phone </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <!-- <input id="customerId" type="number" class="form-control" name="customer_id" min="0" max="99999" value="0" placeholder=""> -->
                      <input id="customerId" type="text" class="form-control" name="customer_id" placeholder="">
                  </div>
                </div>
