            ...
            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
              <div class="profile_img">
                <div id="crop-avatar">
                  ...
                  <img class="img-responsive avatar-view" src="<?php echo base_url();?>files/<?php echo $customer_detail->upload_path.'/'.$customer_detail->image_path; ?>" alt="Avatar" title="Customer's Photo">
                  <?php } else {?>
                    ...
                    <table class="data table table-bordered no-margin">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><b>Head of Sales</b></td>
                          <td><?php echo $head_of_sales;?></td>
                        </tr>
                      </tbody>
                    </table>
                    <!-- end user projects -->
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php if($customer_detail->image_path != NULL){ ?>
                            <a href="<?php echo base_url();?>files/<?php echo $customer_detail->upload_path.'/'.$customer_detail->image_path;?>" target="_blank">Click here to download!</a>
                            <?php } else { echo "Not Found!";}?>
                          </td>
                          <td><b>National ID</b></td>
                          <td><?php if($customer_detail->nid_path != NULL){ ?>
                            <a href="<?php echo base_url();?>nid/<?php echo $customer_detail->upload_path.'/'.$customer_detail->nid_path;?>" target="_blank">Click here to download!</a>
                            <?php } else { echo "Not Found!";}?>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td><?php if($customer_detail->inspection_form != NULL){ ?>
                            <a href="<?php echo base_url();?>inspection_form/<?php echo $customer_detail->upload_path.'/'.$customer_detail->inspection_form;?>" target="_blank">Click here to download!</a>
                            <?php } else { echo "Not Found!";}?>
                          </td>
                          <td><b>Purchase Order</b></td>
                          <td><?php if($customer_detail->purchase_order != NULL){ ?>
                            <a href="<?php echo base_url();?>purchase_order/<?php echo $customer_detail->upload_path.'/'.$customer_detail->purchase_order;?>" target="_blank">Click here to download!</a>
                            <?php } else { echo "Not Found!";}?>
                          </td>
                        </tr>
                      </tbody>
