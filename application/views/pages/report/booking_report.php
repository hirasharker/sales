    ...
    <div class="col-md-12 col-xs-12">
        <div class="x_panel">
            ...
            <form class="form-horizontal form-label-left" method="post"  enctype='multipart/form-data'>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Dealer </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                  ...
                  $(function() { 
                      ...
                      $("#generate").click(function(){ 
                          ...
                          $.ajax({
                                  ...
                                  data: { 'zone_id': zoneId, 'city_id' : cityId, 'mkt_id' : mktId, 'dealer_id' : dealerId, 'model_id': modelId, 'payment_mode': paymentMode,'status': status, 'start_date': startDate, 'end_date': endDate  },
                                  success: function(data){
                                      // Parse the returned json data
                                      var opts = $.parseJSON(data);
                                      // Use jQuery's each to iterate over the opts value
