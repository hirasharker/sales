...
<script type="text/javascript">
    ...
    var data = google.visualization.arrayToDataTable([
        ['Month', 'Sales'],
        ['January',  <?php if($sales_quantity_of_january !=NULL) {echo $sales_quantity_of_january;}else {echo 0;} ?>],
        ['Fabruary',  <?php if($sales_quantity_of_february !=NULL) {echo $sales_quantity_of_february;}else {echo 0;} ?>],
        ['March',  <?php if($sales_quantity_of_march !=NULL) {echo $sales_quantity_of_march;}else {echo 0;} ?>],
        ['April',  <?php if($sales_quantity_of_april !=NULL) {echo $sales_quantity_of_april;}else {echo 0;} ?>],
        ['May', <?php if($sales_quantity_of_may !=NULL) {echo $sales_quantity_of_may;}else {echo 0;} ?>],
        ['June', <?php if($sales_quantity_of_june !=NULL) {echo $sales_quantity_of_june;}else {echo 0;} ?>],
        ['July', <?php if($sales_quantity_of_july !=NULL) {echo $sales_quantity_of_july;}else {echo 0;} ?>],
        ['August', <?php if($sales_quantity_of_august !=NULL) {echo $sales_quantity_of_august;}else {echo 0;} ?>],
        ['September', <?php if($sales_quantity_of_september !=NULL) {echo $sales_quantity_of_september;}else {echo 0;} ?>],
        ['October', <?php if($sales_quantity_of_november !=NULL) {echo $sales_quantity_of_november;}else {echo 0;} ?>],
